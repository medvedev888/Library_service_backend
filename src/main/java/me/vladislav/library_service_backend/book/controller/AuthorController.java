...
public class AuthorController {
    ...
    @PreAuthorize("hasRole('LIBRARIAN')")
    @PostMapping("/import")
    public ResponseEntity<ApiResponse> importAuthors(@RequestParam("file") MultipartFile file) {
        authorService.importAuthorsFromJson(file);
        return ResponseEntity.ok(ApiResponse.success("Авторы импортированы", null));
    }
